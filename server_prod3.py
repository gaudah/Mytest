...
<br><br>
  ...
  <button id="b3" onclick="location.href='/coding1/hr/hrms.html';" value="Go to Google" />Back</button>
...
<table width="100%" align="center">
  ...
  <tr>
    <td height="417" align="center" valign="top" bgcolor="#ffcdd2">   <p align="center" class="style37"></p>
      <form id="form1" name="form1" method="post" action="signupjsp.jsp">
        <table width="51%" height="336" border="0">

             <tr><td><center><h2>Added to cart</h2></center></td></tr>
              <tr>
            <td><label>Product Image: </label></td>
            <td><div id="x"></div></td>
          </tr>
          ...
          <tr>
          <td><label>Cart subtotal(item):price</label></td>
          <td><p><span id='display1'></span></p></td>
          </tr>
        ...
        <p>&nbsp;  </p>
        <p>
  <input type="submit" name="Submit1" value="Cart:User cart will open" />
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;
...
def application(environ, start_response):
    ...
    SQL="INSERT into cart (img1,qty,price) VALUES(%s,%s,%s);"
    data=(str1,str2,str3,)
    cur.execute(SQL,data)
