...
def application(environ, start_response):
    ...
    if environ['REQUEST_METHOD'] == 'POST':
        ...
        html1=""
        if(res1==[]):
            html1=html1+"<html><head><script>alert('Login id is incorrect please enter correct login id');</script></head></html>"
        elif(res1[0][0]==str6):
            SQL="delete from address where loginid=%s";
            data=(str6,)
            cur.execute(SQL,data)
           
            h1='Deleted successfully'
           
            html1=html1+"<html><head><script>document.write('<h2>'+'Deleted successfully'+'</h2>');</script></head></html>"
