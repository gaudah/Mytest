...
<br><br>
  ...
  <button id="b4" onclick="location.href='/prod2';" value="Go to Google" />Add to wishlist</button>

  <button id="b5" onclick="location.href='/prod3';" value="Go to Google" />Add to cart</button>

  <button id="b6" onclick="location.href='/serverproceed';" value="Go to Google" />Buy now</button>
...
<table width="100%" align="center">
  ...
  <input type="submit" name="Submit1" value="View Wishlist" />
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;

  <button id="b6" onclick="location.href='/serverprod101';" value="Go to Google" />Continue shopping</button>
<p align="center">&nbsp;</p>
    <p>&nbsp;</p></td>
  </tr>
</table>
...
def application(environ, start_response):
    ...
    print lst2
    store=lst2[0]
    SQL="select * from prod1 where img1=%s;"
    data=(store,)
    ...
    str2=h2
    str3=h6
    print "got values",str1,str2,str3
  
    SQL="INSERT into wishlist (s1,s2,s3) VALUES(%s,%s,%s);"
    data=(str1,str2,str3,)
    cur.execute(SQL,data)
    ...
    html=form2
    html=html+"<html><head><script>var img = document.createElement('img');img.src = '%s';img.width='111';img.height='91';var src = document.getElementById('x');src.appendChild(img);document.getElementById('display0').innerHTML = '%s';document.getElementById('display1').innerHTML = '%s';</script></head></html>" %(h1,h2,h6)
